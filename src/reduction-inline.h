...
#ifndef OPENSHMEM_COLLECTIVE_ROUTINES_REDUCTION_INLINE_H
#define OPENSHMEM_COLLECTIVE_ROUTINES_REDUCTION_INLINE_H

#include "global.h"

#define SHCOLL_REDUCE_DECLARE(_name, _type, _algorithm)                                                         \
    void shcoll_##_name##_to_all_##_algorithm##_i(_type *dest, const _type *source, int nreduce, int PE_start,  \
...
#endif //OPENSHMEM_COLLECTIVE_ROUTINES_REDUCTION_INLINE_H
